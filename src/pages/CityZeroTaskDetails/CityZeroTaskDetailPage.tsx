...
const CityZeroTaskDetailPage: React.FC = () => {
    // The id from the URL, if we need to fetch specific data later
    ...
    return (
        <div className="task-detail-page">
            ...
            <section className="task-detail-hero">
                <img src="/CityZero/task_board.png" alt="Task Board" className="task-detail-hero-image" />
            </section>
                ...
                <div className="task-detail-content">
                    ...
                    <div className="task-head-info">
                        <div className="task-head-left">
                            <h1 className="task-title">Event Name - AI hackathon at Ohio State</h1>
...
export default CityZeroTaskDetailPage;
