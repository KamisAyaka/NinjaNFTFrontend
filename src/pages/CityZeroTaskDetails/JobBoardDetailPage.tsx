...
const JobBoardDetailPage: React.FC = () => {
    useEffect(() => {
    ...
    return (
        <div className="task-detail-page">
            ...
            <section className="task-detail-hero">
                <img src="/CityZero/job.png" alt="Job Board" className="task-detail-hero-image" />
            </section>
                ...
                <div className="task-detail-content">
                    ...
                    <div className="task-head-info">
                        <div className="task-head-left">
                            ...
                            <h3 className="task-subtitle">Organized by Buckeye Fintech Group</h3>
...
export default JobBoardDetailPage;
